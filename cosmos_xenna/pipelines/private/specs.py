...
class ExecutionMode(enum.Enum):
    ...
    # serving scenarios where requests arrive dynamically via input Ray queues and results are pushed
    # to output Ray queues. Workers remain active indefinitely waiting for new requests.
    SERVING = 2
